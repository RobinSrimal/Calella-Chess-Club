export const en = {
  ...
  admin: {
    ...
    users: {
      ...
      empty: "There are no users for these filters.",
      filters: "Filters",
      ...
      allRoles: "All roles",
      allAccountStatuses: "All accounts",
      username: "User",
      email: "Email",
      ...
      approvedSuccess: "Membership approved.",
      rejectedSuccess: "Membership rejected.",
      restoredSuccess: "Membership restored to pending.",
      disabledSuccess: "Account disabled.",
      loginRequired: "Log in to manage users.",
      forbidden: "You need admin access to manage users.",
      retry: "Reload",
    },
  },
} as const;
